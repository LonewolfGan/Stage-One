  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.18, ease: [0, 0, 0.2, 1] }}
        onClick={(e) => e.stopPropagation()}
        style={{ width: "100%", maxWidth: 440, backgroundColor: ds.colors.canvas, borderRadius: 14, border: `1px solid ${ds.colors.border}`, overflow: "hidden", maxHeight: "90vh", overflowY: "auto" }}
      >
