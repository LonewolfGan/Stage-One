  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 6, display: "flex", alignItems: "baseline", gap: 6 }}>
        <h3 style={{ fontSize: 24, fontWeight: 600, color: ds.colors.ink, letterSpacing: "-0.015em", margin: 0 }}>
          {value}
        </h3>
        ...
        <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 6 }}>
          <span
            style={{
              fontSize: 12,
              fontWeight: 500,
              color: trend === "up" ? ds.colors.success : trend === "down" ? ds.colors.error : ds.colors.inkTertiary,
            }}
          >
